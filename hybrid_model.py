...
class HybridTradingModel:
    ...
    def __init__(self, lstm_model_path='models/lstm_consolidated.h5',
                 ppo_model_path='models/ppo_gold_agent'):
    ...
    def get_trading_signal(self, df, current_idx):
        ...
        lstm_input = df.iloc[current_idx-60:current_idx][['open', 'high', 'low', 'close']].values
