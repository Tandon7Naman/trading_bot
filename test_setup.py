...
def test_audit():
    ...
    logger.log("TRADE", symbol="MCX:GOLDPETAL", action="BUY", price=68500, qty=1, details="Test buy order")
    logger.log("TRADE", symbol="MCX:GOLDPETAL", action="SELL", price=68550, qty=1, details="Test sell order")
