...
def train_lstm_model(
    X_train, y_train, X_test, y_test, model_path="models/lstm_signal_v2_traintest.h5"
):
    """
...
def main():
    ...
    print("✓ LSTM trained on train data only")
    print(f"✓ Model saved: {model_path}")
    print(f"✓ Scaler saved: {scaler_path}")
    print("\nNEXT: Update backtest.py to:")
    print(f"  1. Load model from {model_path}")
    print(f"  2. Load scaler from {scaler_path}")
    print("  3. Run backtest on 2021-2025 data only")
    print("  4. Compare metrics to full-period backtest (11.55% return)")
