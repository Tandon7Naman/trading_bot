...
class BacktestEngine:
    ...
    def print_performance_summary(self, metrics: Dict[str, Any]):
        ...
        print(f"  - Wins:           {metrics.get('Winning Trades', 0)}")
        print(f"  - Losses:         {metrics.get('Losing Trades', 0)}")
        print("-" * 60)
...
if __name__ == "__main__":
    ...
    print("This script is not meant to be run directly. Run backtest_mcx.py instead.")
