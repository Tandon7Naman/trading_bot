...
class FeatureEngine:
    ...
    # Fair Value (1)
    def calculate_fair_value_feature(
        self, spot_gold_usd, usdinr, duty_rate, current_price, bank_premium_pct=0.015, gst_rate=0.03
    ):
        """
    ...
    def extract_features(self, market_data):
        features = [
            ...
            self.calculate_bid_ask_spread(
                market_data["bid"], market_data["ask"], market_data["closes"][-1]
            ),
            ...
            self.calculate_monsoon_feature(
                market_data["monsoon_rainfall"], market_data["monsoon_lpa"]
            ),
            self.calculate_real_yield_feature(
                market_data["us_10y_yield"], market_data["inflation_rate"]
            ),
            ...
            self.calculate_fair_value_feature(
                market_data["spot_gold_usd"],
                market_data["usdinr"],
