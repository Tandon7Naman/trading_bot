...
class TestMainBotGatewayIntegration(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            raise RuntimeError(f"Failed to initialize GoldTradingBot: {e}") from e
    ...
    def test_02_gateway_modules_exist(self):
        ...
        for attr_name, expected_class in required_modules.items():
            self.assertTrue(hasattr(self.bot, attr_name), f"Bot missing attribute: {attr_name}")

            module_instance = getattr(self.bot, attr_name)
            self.assertIsNotNone(module_instance, f"Module {attr_name} is None")
    ...
    def test_04_risk_manager_position_sizing(self):
        ...
        print("  ✓ Entry: ₹69,000 | Stop Loss: ₹68,800 | Risk: ₹200/lot")
    ...
    def test_05_required_methods_exist(self):
        ...
        for method_name in required_methods:
            self.assertTrue(hasattr(self.bot, method_name), f"Bot missing method: {method_name}")
    ...
    def test_07_risk_manager_limits(self):
        ...
        print("  ✓ RiskManager initialized with proper limits")
