    ...
    def generate_signals(self, df):
        ...
        try:
            ...
            for i in range(1, len(df)):
                ...
                if (
                    predicted_price > current_price * 1.01  # 1% predicted increase
                ...
                # SELL Signal: Predicted < Current - Price below SMAs + RSI > 30
                    ...
                    predicted_price < current_price * 0.99  # 1% predicted decrease
                    and current_price < sma20
                    and sma20 < sma50
                    and rsi > 30
                ):
...
def main():
    ...
    if not trades_df.empty:
        ...
        # Save trades CSV
        print("[+] Results saved:")
        print("    • trades: results/backtest_trades.csv")
        print("    • metrics: results/backtest_metrics.json\n")
