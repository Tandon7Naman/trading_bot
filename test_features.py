...
def test_features():
    ...
    print("\nFeature Values:")
    feature_names = [
        "1. RSI", "2. MACD", "3. BB Width", "4. ADX",
        "5. Bid-Ask Spread", "6. Order Imbalance",
        "7. USD/INR", "8. US 10Y Yield", "9. Au/Ag Ratio",
        "10. Monsoon", "11. Real Yield",
        "12. Import Duty", "13. Duty Shock", "14. Lunar Demand", "15. Fair Value"
    ]
    ...
    print(f"  All values in [-1, 1]: {'✅ PASS' if np.all((features >= -1) & (features <= 1)) else '❌ FAIL'}")
