...
def test_phase_2():
    ...
    RiskManager.calculate_lot_size(
        equity, entry, sl, "XAUUSD", confidence_score=1.0, current_portfolio_risk_usd=0.0
    )
    ...
    RiskManager.calculate_lot_size(
        equity, entry, sl, "XAUUSD", confidence_score=1.0, current_portfolio_risk_usd=4900.0
    )
    ...
    RiskManager.calculate_lot_size(
        equity, entry, sl, "XAUUSD", confidence_score=1.0, current_portfolio_risk_usd=5100.0
    )
